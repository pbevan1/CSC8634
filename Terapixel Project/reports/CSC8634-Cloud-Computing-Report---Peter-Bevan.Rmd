...
### task.x.y
the x and y coordinates of the section of image being rendered for each task. `level` represents the zoom level, of the 12 zoom levels of the visualisation.
...
```{r}
pairs(gpu_performance[,-c(1:3)], col = rgb(red = 0, green = 0, blue = 0, alpha = 0.1))
```
